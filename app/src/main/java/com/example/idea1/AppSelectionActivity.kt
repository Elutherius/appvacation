...
class AppSelectionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        monitoredAppsContainer = findViewById(R.id.monitoredAppsContainer)
    ...
    fun toggleMonitoredApps(view: View) {
        if (monitoredAppsContainer.visibility == View.VISIBLE) {
            monitoredAppsContainer.visibility = View.GONE
        } else {
            monitoredAppsContainer.visibility = View.VISIBLE
        }
    }
}
